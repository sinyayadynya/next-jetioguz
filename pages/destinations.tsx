                        ...
                        <div className="bg-white mt-24">
                            <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                                <h1 className="text-3xl font-bold tracking-tight text-gray-900">
                                    Places to discover in Jeti Oguz
                                </h1>
                                <p className="mt-4 max-w-xl text-sm text-gray-700">
                                    A land of stunning natural beauty, rich culture and adventure in the heart of the Tien Shan mountains. Explore charming villages, pristine lakes, wild landscapes and wellness escapes in this mountain paradise.
                                </p>
                            </div>
                        </div>
