...
//   return (
//     <svg viewBox="0 0 240 480" aria-hidden="true" {...props}>
//       <path
//         fill="#F2F2F2"
//         fillRule="evenodd"
//         clipRule="evenodd"
...
export function MapFrame({
  ...
  return (
    <div className={clsx('relative aspect-[640/480]', className)} {...props}>
      <div className="absolute inset-y-0 left-0 right-0 rounded-lg shadow-2xl" />
      <div className="absolute left-0 top-0 grid h-full w-full transform grid-cols-1 overflow-hidden bg-gray-900">
        {children}
      </div>
