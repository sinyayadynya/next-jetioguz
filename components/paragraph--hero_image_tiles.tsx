...
export function ParagraphHeroImageTiles({ paragraphType }: ParagraphProps) {
    return (
        <div className="bg-white">
            <div className="relative isolate">
                ...
                >
                    <div
                        className="aspect-[801/1036] w-[50.0625rem] bg-gradient-to-tr from-[#fed7aa] to-[#c2410c] opacity-30"
                        style={{
                            clipPath:
