...
export function NodeArticleRow({ node, ...props }: NodeArticleRowProps) {
  ...
  return (
    <article
      className="relative grid grid-cols-[120px_1fr] items-start gap-4 p-4 overflow-hidden bg-white border border-gray-50 group"
      {...props}
    >
      ...
      <div className="flex items-start justify-between text-text">
        ...
        <button
          ...
          className="px-2 py-1 text-white rounded-md hover:bg-red-600 bg-red-600/80"
        >
          {t("delete")}
        </button>
      </div>
