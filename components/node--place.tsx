                    ...
                    <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
                        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
                            <div className="mt-24 sm:mt-32 lg:mt-16">
                                <a href="/destinations" className="inline-flex space-x-6">
                            ...
                            <h1 className="mt-10 text-4xl font-serif font-bold tracking-tight text-gray-900 sm:text-6xl">
                                {node.title}
                            </h1>
                            ...
                            Are you ready to immerse yourself in the breathtaking natural beauty of Jeti Oguz? Explore the stunning landscapes of the region's most incredible nature sites, from serene lakes and rivers to towering mountains and lush valleys.
                            </p>
                ...
                <div className="overflow-hidden">
                    <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
                        ...
                        <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                            <h2 className="hidden text-3xl font-serif font-bold tracking-tight text-gray-900 sm:text-4xl">
                                About
                            </h2>
                            {node.body && (
