...
export declare type FilterItemShortest = string;
export declare type FilterItemShort = {
    operator: string;
    value: string;
};
...
export declare type FilterItemType = FilterItem | FilterItemShort | FilterItemShortest;
...
export declare class DrupalJsonApiParams implements DrupalJsonApiParamsInterface {
     ...
     * @category JSON:API Query
     */
    addPageOffset(offset: number): DrupalJsonApiParams;
    /**
     ...
     */
    setQsOption(options: object): DrupalJsonApiParams;
    /**
