...
var cache = new NodeCache__default["default"]();
...
var dataFormatter = new Jsona__default["default"]();
...
var getResourceByPath = function getResourceByPath(path, options) {
  try {
    ...
    var resourceParams = qs.stringify(params);
    var payload = [{
      requestId: "router",
      action: "view",
...
var DrupalClient = /*#__PURE__*/function () {
  ...
  function DrupalClient(baseUrl, options) {
    ...
    var _options2 = options,
        ...
        serializer = _options2$serializer === void 0 ? new Jsona__default["default"]() : _options2$serializer,
  ...
  _proto.getResourceByPath = function getResourceByPath(path, options) {
    try {
      ...
      var resourceParams = qs.stringify(params); // We are intentionally not using translatePath here.
...
exports.getSearchIndexFromContext = getSearchIndexFromContext;
exports.getView = getView;
exports.syncDrupalPreviewRoutes = syncDrupalPreviewRoutes;
exports.translatePath = translatePath;
exports.translatePathFromContext = translatePathFromContext;
